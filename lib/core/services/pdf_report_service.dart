                      ...
                      pw.Container(
                        ...
                        child: pw.Column(
                          ...
                          children: [
                            ...
                            pw.Text('***REMOVED***', style: pw.TextStyle(font: fonts.bold, fontSize: 9)),
                            pw.Text('***REMOVED***', style: pw.TextStyle(font: fonts.bold, fontSize: 9)),
                            ...
                            pw.Padding(
                              ...
                              child: pw.Column(
                                crossAxisAlignment: pw.CrossAxisAlignment.start,
                                children: [
                                  pw.Text('IČO: ***REMOVED***', style: pw.TextStyle(font: fonts.regular, fontSize: 9)),
                                  pw.Text('Mobil: ***REMOVED***', style: pw.TextStyle(font: fonts.regular, fontSize: 9)),
                            ...
                            pw.Expanded(
                              child: pw.Column(
                                ...
                                children: [
                                  ...
                                  pw.Padding(
                                    padding: const pw.EdgeInsets.only(left: 8),
                                    child: pw.Text('***REMOVED***', style: pw.TextStyle(font: fonts.bold, fontSize: 9)),
                                  ),
                                  pw.Padding(
                                    padding: const pw.EdgeInsets.only(left: 8),
                                    child: pw.Text('***REMOVED***', style: pw.TextStyle(font: fonts.bold, fontSize: 9)),
                            ...
                            pw.Column(
                              ...
                              children: [
                                ...
                                pw.Padding(
                                  ...
                                  child: pw.Text('IČO: ***REMOVED***', style: pw.TextStyle(font: fonts.regular, fontSize: 9)),
                                ),
                                pw.Padding(
                                  padding: const pw.EdgeInsets.only(right: 8),
                                  child: pw.Text('DIČ: ***REMOVED***', style: pw.TextStyle(font: fonts.regular, fontSize: 9)),
                                ),
                              ],
                            ),
                          ],
                        ...
                        child: pw.Padding(
                          ...
                          child: pw.Column(
                            ...
                            children: [
                              ...
                              pw.Text('IBAN: ***REMOVED***', style: pw.TextStyle(font: fonts.regular, fontSize: 9)),
                              pw.RichText(
                                text: pw.TextSpan(
                                  children: [
                                    pw.TextSpan(
              ...
              pw.Table(
                ...
                children: [
                  ...
                  pw.TableRow(
                    ...
                    children: [
                      _invoiceCell('***REMOVED***', fonts.regular, 9, left: 8),
                              ...
                              child: pw.Column(
                                children: [
                                  pw.BarcodeWidget(
                                    ...
                                    data: 'SPD*1.0*ACC:***REMOVED****AM:${totalAmount.toStringAsFixed(2)}*CC:CZK*X-VS:$vs*MSG:Vyvoj aplikace Artemis',
