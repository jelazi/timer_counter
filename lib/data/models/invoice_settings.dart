...
class InvoiceSettings {
  ...
  const InvoiceSettings({
    this.supplier = const InvoiceParty(
      ...
      addressLine2: '***REMOVED***',
      ico: '***REMOVED***',
      phone: '***REMOVED***',
      email: 'lzizka@gmail.com',
    ),
    this.customer = const InvoiceParty(name: '***REMOVED***', addressLine1: '***REMOVED***', addressLine2: '***REMOVED***', ico: '***REMOVED***', dic: '***REMOVED***'),
    this.description = '***REMOVED***',
    this.bankName = '',
    this.bankCode = '6210',
    this.swift = '',
    this.accountNumber = '***REMOVED***',
    this.iban = '***REMOVED***',
