...
class SettingsRepository {
  ...
  // Invoice description
  String getInvoiceDescription() => _box.get(AppConstants.invoiceDescription, defaultValue: '***REMOVED***') as String;
  ...
  String getInvoiceAccountNumber() => _box.get(AppConstants.invoiceAccountNumber, defaultValue: '***REMOVED***') as String;
  Future<void> setInvoiceAccountNumber(String v) => _box.put(AppConstants.invoiceAccountNumber, v);

  String getInvoiceIban() => _box.get(AppConstants.invoiceIban, defaultValue: '***REMOVED***') as String;
