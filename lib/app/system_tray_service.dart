...
class TrayRunningTimerInfo {
  ...
  const TrayRunningTimerInfo({required this.id, required this.projectName, required this.taskName, required this.elapsed});
}
...
class SystemTrayService {
  ...
  /// Build a rich tray menu with running timers and project/task quick-start.
